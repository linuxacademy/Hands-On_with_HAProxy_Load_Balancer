#!/bin/bash
# haproxy_troubleshooting_environment_setup.sh
# Script to create a backend container web farm for HAProxy lessons
# Troubleshooting HAProxy Issues lesson
# 5/28/2021 - Tom Dean
...
sudo curl https://raw.githubusercontent.com/linuxacademy/Hands-On_with_HAProxy_Load_Balancer/main/haproxy-troubleshooting.cfg -o /etc/haproxy/haproxy.cfg
